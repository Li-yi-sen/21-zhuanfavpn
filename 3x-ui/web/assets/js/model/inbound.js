...
class TcpStreamSettings extends XrayCommonClass {
    constructor(
        ...
        this.enhancedObfuscation = enhancedObfuscation;
    }
    ...
    static fromJson(json = {}) {
        ...
        if (json.header) {
            if (json.header.type === 'http') {
                request = TcpStreamSettings.TcpRequest.fromJson(json.header.request);
                response = TcpStreamSettings.TcpResponse.fromJson(json.header.response);
            }
        }
        return new TcpStreamSettings(
            ...
            request,
            response,
            json.enhancedObfuscation || false,
        );
    }
    ...
    toJson() {
        const json = {
            ...
            enhancedObfuscation: this.enhancedObfuscation,
        };
        if (this.type === 'http') {
            json.header = {
                type: 'http',
...
RealityStreamSettings.Settings = class extends XrayCommonClass {
    ...
    static fromJson(json = {}) {
        return new RealityStreamSettings.Settings(
            json.publicKey,
            json.fingerprint || UTLS_FINGERPRINT.UTLS_CHROME,
            json.serverName,
            json.spiderX,
            json.mldsa65Verify
        );
